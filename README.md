...
Command-line client for the full UniProt REST API surface, with dataset shortcuts, specialized endpoint commands, asynchronous ID mapping, direct operation calls, offline docs, and optional local caching.
